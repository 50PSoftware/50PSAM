...
namespace _50PSAM
{
    partial class AboutMe : Form
    {
        ...
        _50P.Software.GetApplications.GetApps ga = new _50P.Software.GetApplications.GetApps();
        private void AboutMe_Load(object sender, EventArgs e)
        {
            textBoxDescription.Text += "Počet nainstalovaných aplikací: " + ga.AppsCount.ToString();
        }
    }
}
